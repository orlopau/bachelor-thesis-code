...
export HOROVOD_TIMELINE=/lustre/ssd/ws/s8979104-horovod/timeline_nccl.json

srun --cpu-bind=none,v --accel-bind=gn \\
    $VENV/bin/python $WS_PATH/sync/src/stress.py --data $WS_PATH/data --project gpu2 --dist